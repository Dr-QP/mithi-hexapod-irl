/* * * *
  CASES for the patterns page
    1: all alpha != 0 and will twist
      a. femur points on the ground, foot tip, coxa and body contact not on ground
    ...
    2. all alpha != 0 and will NOT twist because body plane is on ground
      a. all coxaPoint on ground, femurPoint Not on ground
        {alpha: 19, beta: 98, gamma: -21}
      b: all femur point on ground, but coxa point also on ground
